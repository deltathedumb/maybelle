...
$form.Size = New-Object Drawing.Size(440, 410)
...
$disableCheck=New-Object Windows.Forms.CheckBox;$disableCheck.Text="Disable Threads";$disableCheck.Location=New-Object Drawing.Point(165,230);$disableCheck.Size=New-Object Drawing.Size(220,24);$form.Controls.Add($disableCheck)
$startButton=New-Object Windows.Forms.Button;$startButton.Text="Start Host";$startButton.Location=New-Object Drawing.Point(165,280);$startButton.Size=New-Object Drawing.Size(110,32);$form.Controls.Add($startButton)
