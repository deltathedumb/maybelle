...
function renderRootList() {
  ...
  roots.forEach((r) => {
    ...
    b.innerHTML = `<span class="list-glyph">${escapeHtml(r.glyph || "·")}</span><div class="list-text"><div class="list-title">${escapeHtml(r.root_name || "Unnamed root")}</div><div class="list-subtitle">${escapeHtml(r.description || "No description")}</div></div>`;
    b.onclick = () => {
      syncEditorsToData();
      selectedRootId = r.id;
      renderRootList();
...
function renderEntryList() {
  ...
  entries.forEach((e) => {
    ...
    b.innerHTML = `<span class="list-glyph">${escapeHtml(e.compound || "·")}</span><div class="list-text"><div class="list-title">${escapeHtml(e.description || "Unnamed word")}</div><div class="list-subtitle">${escapeHtml(e.literal_meaning || "No details")}</div></div>`;
    b.onclick = () => {
      syncEditorsToData();
      selectedEntryId = e.id;
      renderEntryList();
